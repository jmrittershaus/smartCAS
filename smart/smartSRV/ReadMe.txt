========================================================================
    KONSOLENANWENDUNG: smartSRV-Projektübersicht
========================================================================

Diese smartSRV-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre smartSRV-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "smartSRV.pch und eine 
